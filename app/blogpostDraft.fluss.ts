...
export type WriteDraftStepFunction = (args: {
  usersIdeas: string
  blogStyle: OptionalString
}) => Promise<string> | string

export type UnderstandStyleStepFunction = (args: {
  examplePosts: ExampleArray
}) => Promise<OptionalString> | OptionalString
...
type StepIO = {
  ...
  understandStyle: {
    input: Parameters<UnderstandStyleStepFunction>[0]
    output: ReturnType<UnderstandStyleStepFunction>
  }
}
  ...
  const flowState: FlowState = {
    ...
    writeDraft: {
      ...
      arguments: [
        ...
        {
          sourceStepId: 'understandStyle',
          argumentName: 'blogStyle',
        },
      ],
    },
    understandStyle: {
      id: 'understandStyle',
      status: 'waiting',
      execute: stepFunctions.understandStyle,
      arguments: [
        {
          sourceStepId: 'start',
